...
import allFeedBackLottie from "../../assets/lotties/Customer positive review.json"
...
const AllFeedbacks = () => {
  ...
  useEffect(() => {
    document.title = "ThreadQube | All Feedbacks";
  }, []);
      ...
      {feedbacks.length === 0 ? (
        <div className="flex flex-col items-center h-screen">
          ...
          <div className="w-72 h-72">
            <Lottie animationData={allFeedBackLottie} loop />
          </div>
          <p className="text-center text-gray-500 ">
            No Feedbacks found at this moment.
          </p>
        </div>
      ) : (
        <>
