    ...
    <footer className="bg-orange-100 text-black">
      <div className="max-w-[1400px] w-[96%] mx-auto px-3 lg:px-4 py-6 md:flex md:items-center md:justify-between">
        ...
        <div className="flex space-x-4">
          <a href={facebookLink} target="_blank" className="hover:text-blue-500">
          ...
          <a href={twitterLink} target="_blank" className="hover:text-sky-400">
            <svg fill="currentColor" className="w-4 h-4" viewBox="0 0 24 24">
          ...
          <a href={linkedinLink} target="_blank" className="hover:text-blue-600">
            <svg fill="currentColor" className="w-4 h-4" viewBox="0 0 24 24">
